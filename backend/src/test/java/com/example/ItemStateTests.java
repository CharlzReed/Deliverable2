...
public class ItemStateTests {
    ...
    public void availalbeTestCheckout() {
        Item book = new Book(1, "Effective Java", LocationType.NORTH_SHELF, 45.0, StatusType.ACTIVE, "Joshua Bloch",
                2008);
        Item cd = new CD(2, "Thriller", LocationType.WEST_SHELF, 15.0, StatusType.ACTIVE, "Michael Jackson", 1982);
        Item magazine = new Magazine(3, "National Geographic", LocationType.SOUTH_SHELF, 5.0, StatusType.ACTIVE,
                "May 2021", "Science");
        Item subscription = new Subscription(4, "JSTOR", LocationType.EAST_SHELF, 100.0, StatusType.ACTIVE,
                "Academic Journal", "Monthly");
        ...
        assertTrue("Book should be in CheckedOutState after checkout",
                bookContext.getState() instanceof CheckedOutState);
        assertTrue("CD should be in CheckedOutState after checkout", cdContext.getState() instanceof CheckedOutState);
        assertTrue("Magazine should be in CheckedOutState after checkout",
                magazineContext.getState() instanceof CheckedOutState);
        assertTrue("Subscription should be in CheckedOutState after checkout",
                subscriptionContext.getState() instanceof CheckedOutState);
    }
    ...
    public void checkedTestCheckout() {
        ...
        assertTrue("The state should remain CheckedOutState after checkout attempt",
                context.getState() instanceof CheckedOutState);
    }
    ...
    public void checkedTestReturnItem() {
        ...
        assertTrue("Magazine should be in AvailableState after return",
                magazineContext.getState() instanceof AvailableState);
        assertTrue("Subscription should be in AvailableState after return",
                subscriptionContext.getState() instanceof AvailableState);
    }
}

...
public class UserTest {
    ...
    //Testing addItem method in user, testing when user does not have enough balance to rent the item
    @Test
    ...
    //Testing addItem method in user, testing when user rents an item with no copies left
    @Test
    ...
    public void userAddItem_Test5() {
        ...
        for(int i=0; i<10; i++) {
            expectedRented.add(testItem1);
            testUser.addItem(itemList.get(0));
            testUser2.addItem(itemList.get(0));
        }

        Assert.assertEquals(expectedRented, testUser.getRentedItems());
        Assert.assertEquals(expectedRented, testUser2.getRentedItems());
        System.out.println(testLibrary.getCopiesAvailable());
        System.out.println(testUser.getAccountBalance());
        Assert.assertTrue(false == testUser3.addItem(itemList.get(0)));
    }
    ...
    //Testing rentItem method in user, testing when user does not have enough balance to rent the item
    @Test
    ...
    //Testing rentItem method in user, testing when user rents an item with no copies left
    @Test
    ...
    public void userRentItem_Test5() {
        ...
        System.out.println(testLibrary.getCopiesAvailable());
        System.out.println(testUser.getAccountBalance());
        Assert.assertTrue(false == testUser3.rentItem(itemList.get(0)));
    }
    ...
    public void userReturnItem_Test2() {
        ...
        Item testItem3 = new Item(2, "Example Magazine", ItemType.MAGAZINE, LocationType.WEST_SHELF, 6.99, StatusType.ACTIVE);
        Item testItem4 = new Item(3, "Example Textbook", ItemType.TEXTBOOK, LocationType.EAST_SHELF, 8.99, StatusType.ACTIVE);
        Item testItem5 = new Item(4, "Example Subscription", ItemType.SUBSCRIPTION, LocationType.SOUTH_SHELF, 4.99, StatusType.ACTIVE);
    ...
    public void userAddCourse_Test1() {
        ...
        Library testLibrary = Library.newInstance();
        Course testCourse = new Course(0, "Intro to Example", "EECS XX01", LocalDate.of(2024, 01, 01), LocalDate.of(2025, 12, 24));
    ...
    public void userAddCourse_Test2() {
        ...
        Library testLibrary = Library.newInstance();
        Course testCourse = new Course(0, "Intro to Example", "EECS XX01", LocalDate.of(2024, 01, 01), LocalDate.of(2024, 04, 05));
    ...
    public void userToStringCSVFormatgetAccountType_Test1() {
        ...
        String expectedString = String.format("(userID=%d,  name=%s,  email=%s,  password=%s,  userType=%s,  accountBalance=%f)", userID,
                name, email, password, userType, accountBalance);
        String expectedFormat = String.format("%d,%s,%s,%s,%s,%f", userID, name, email, password, userType, accountBalance);;

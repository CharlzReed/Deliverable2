...
public class SubscriptionTest {
    ...
    void testSubscriptionConstructorAndGetters() {
        Subscription subscription = (Subscription) ItemFactory.createSubscription(4, "JSTOR", LocationType.EAST_SHELF,
    ...
    public void testSubscriptionCsvFormat() {
        ...
        String expectedCsv = "4,JSTOR,SUBSCRIPTION,EAST_SHELF,100.0,ACTIVE,Academic Journal,Monthly";
    ...
    public void testSubscriptionInactiveState() {
        ...
        assertFalse("Subscription should not be available for access in INACTIVE state", subscription.isAvailable());
    }
}

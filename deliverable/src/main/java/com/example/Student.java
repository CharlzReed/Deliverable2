...
public class Student extends User {
    ...
    public Student(int userID, String userName, String email, UserType userType, boolean isVerified, int studentID, double accountBalance) {
        super(userID, userName, email, userType, isVerified, accountBalance);
